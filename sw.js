/* ==========================================================================
   ...
   BUILD in app.js and the number on version.html the same; check-site.js
   refuses the build if they drift apart.

   This used to live at service-worker.js. That address now holds a kill switch
   instead, because phones registered against it were stuck serving files from
   months ago and nothing shipped inside the shop could reach them. Registering
   here gives those phones a clean worker once the old one has released them.
   ========================================================================== */

const CACHE_VERSION = 'homcom-v26';
